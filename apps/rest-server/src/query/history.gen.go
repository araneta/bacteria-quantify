...
func newHistory(db *gorm.DB, opts ...gen.DOOption) history {
	...
	_history.UpdatedAt = field.NewTime(tableName, "updatedAt")
	_history.DeletedAt = field.NewTime(tableName, "deletedAt")
...
type history struct {
	...
	SampleName     field.String // NGS generated
	UserID         field.Int32  // NGS generated
	LocalFileImage field.String // NGS generated
